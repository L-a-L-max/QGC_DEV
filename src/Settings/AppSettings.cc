...
DECLARE_SETTINGSFACT(AppSettings, virtualJoystickMaxSpeed)
DECLARE_SETTINGSFACT(AppSettings, virtualJoystickDeadzone)
DECLARE_SETTINGSFACT(AppSettings, virtualJoystickExpo)
DECLARE_SETTINGSFACT(AppSettings, ddsDataSource)
DECLARE_SETTINGSFACT(AppSettings, ddsUsbJoystickEnabled)
