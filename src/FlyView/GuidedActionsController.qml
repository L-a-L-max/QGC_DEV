...
Item {
    ...
    property bool showRTL:                  _guidedActionsEnabled && _vehicleArmed && _activeVehicle && _activeVehicle.supports && _activeVehicle.supports.guidedMode && _vehicleFlying && !_vehicleInRTLMode
    property bool showTakeoff:              _guidedActionsEnabled && _activeVehicle && _activeVehicle.supports && (_activeVehicle.supports.guidedTakeoffWithAltitude || _activeVehicle.supports.guidedTakeoffWithoutAltitude) && !_vehicleFlying && _canTakeoff
    property bool showLand:                 _guidedActionsEnabled && _activeVehicle && _activeVehicle.supports && _activeVehicle.supports.guidedMode && _vehicleArmed && !_activeVehicle.fixedWing && !_vehicleInLandMode
    ...
    property bool showPause:                _guidedActionsEnabled && _vehicleArmed && _activeVehicle && _activeVehicle.supports && _activeVehicle.supports.pauseVehicle && _vehicleFlying && !_vehiclePaused && !_fixedWingOnApproach
    property bool showChangeAlt:            _guidedActionsEnabled && _vehicleFlying && _activeVehicle && _activeVehicle.supports && _activeVehicle.supports.guidedMode && _vehicleArmed && !_missionActive
    property bool showChangeLoiterRadius:   _guidedActionsEnabled && _vehicleFlying && _activeVehicle && _activeVehicle.supports && _activeVehicle.supports.guidedMode && _vehicleArmed && !_missionActive && _vehicleInFwdFlight && fwdFlightGotoMapCircle.visible
    property bool showChangeSpeed:          _guidedActionsEnabled && _vehicleFlying && _activeVehicle && _activeVehicle.supports && _activeVehicle.supports.guidedMode && _vehicleArmed && !_missionActive && _speedLimitsAvailable
